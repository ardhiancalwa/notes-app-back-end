...
const editNoteByIdHandler = (request, h) => {
  ...
  const { title, tags, body } = request.payload;
  const updatedAt = new Date().toISOString(); //memperbarui nilai

  const index = notes.findIndex((note) => note.id === id); //dapatkan dulu index array pada objek catatan sesuai id yang ditentukan
